 ...
 *  @param cb_data Data structure containing redis connection and timeout information.
 *  @return Void.
 */
 ...
 */
void redis_task_log_publish_push_cb(redisAsyncContext *c, void *r, void *privdata);
