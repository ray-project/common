...
void object_table_lookup(db_handle *db_handle,
  ...
  init_table_callback(db_handle, object_id, NULL, &retry, done_cb, fail_cb, user_context);
}
...
void object_table_subscribe(db_handle *db_handle,
                            object_id object_id,
  ...
  object_table_subscribe_data *sub_data = malloc(sizeof(object_table_subscribe_data));
  ...
  init_table_callback(db_handle, object_id, sub_data, &retry, done_cb, fail_cb, user_context);
}
