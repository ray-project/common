...
void task_log_publish(db_handle *db_handle,
  ...
  table_callback_data *cb_data =
          init_table_callback(db_handle, *task_instance_id(task_instance), task_instance,
                              &retry, done_cb, fail_cb, user_context);
...
void task_log_subscribe(db_handle *db_handle,
  ...
  table_callback_data *cb_data =
          init_table_callback(db_handle, node, sub_data, &retry, done_cb, fail_cb, user_context);
